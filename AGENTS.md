...
- Codex API for NLP item classification; Gemini Vision for menu-photo extraction; keys in .env
- dashboard/ is Next.js + TypeScript (npm) and has its own AGENTS.md/AGENTS.md
